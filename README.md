...
- **인터랙티브 기획**: 기획 초안을 작성한 뒤, Claude CLI와 Gemini CLI의 상호작용 도구(ask_user 등)를 활용하여 기획의 빈틈을 찾고 단점을 보완합니다. AI와의 적극적인 피드백 루프를 통해 초기 설계의 완성도를 극대화한 뒤 구현에 착수합니다. 이러한 인터랙티브한 기획 방식을 선호하기에, 대화형 기획에 특화된 **conductor**와 환경 제어권이 강력한 **superpowers**를 핵심 스킬로 활용하고 있습니다.
